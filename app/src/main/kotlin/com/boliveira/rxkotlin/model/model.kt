...
object Model {
    data class ODMOrganizations(var metadata: ODMMetadata, val data: ODMData)
    ...
    data class ODMMetadata(val version: Int,
                           ...
                           @SerializedName("image_path_prefix") val imagePrefix: String)

    data class ODMData(val paging: ODMDataPaging, val items: Array<Item>)
    ...
    data class ODMDataPaging(@SerializedName("total_items") val totalItems: Int,
                             ...
                             @SerializedName("items_per_page") val perPage: Int)

    data class Item(
            @SerializedName("uuid") val identifier: String,
            @SerializedName("type") val type: String,
            @SerializedName("properties") val properties: ItemProperties)
    ...
    data class ItemProperties(
            ...
            @SerializedName("updated_at") val updatedAtSeconds: Long) {
